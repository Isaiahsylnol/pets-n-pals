  ...
  if (user) {
    return (
      <div className="justify-center w-full">
        ...
        <main className="h-screen sm:flex justify-center gap-6 p-6 mt-8 md:grid-cols-2">
          {/* User profile widget - START */}
          <div className="h-min w-full sm:w-3/4 lg:w-2/5 rounded-xl border-2 border-gray-300 bg-gray-100 p-6 max-w-lg">
            ...
            <div className="w-full p-6 space-y-1">
              ...
              <div className="mt-10 grid grid-cols-1 gap-2 text-white w-44">
                <button className="h-10 mt-12 rounded bg-yellow-500 font-bold hover:bg-yellow-600">
